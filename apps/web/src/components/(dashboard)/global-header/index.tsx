...
// import { DropdownMenu, DropdownMenuContent, DropdownMenuItem, DropdownMenuLabel, DropdownMenuSeparator, DropdownMenuTrigger } from '@documenso/ui/primitives/dropdown-menu';
...
// const GlobalMenu = ({ user, teams: initialTeamsData }) => {
...
//   const formatAvatarFallback = (teamName) => {
...
//   const formatSecondaryAvatarText = (team) => {
//     if (!team) {
...
//   const formatRedirectUrlOnSwitch = (teamUrl) => {
...
//   return (
//     <header className="mx-auto flex w-full max-w-screen-xl items-center justify-between gap-x-4 px-4 md:justify-normal md:px-8 py-3 border-b border-gray-200 hidden md:block">
...
//               </Button>
//             </DropdownMenuTrigger>
//             <DropdownMenuContent className={cn('z-[60] ml-6 w-full md:ml-0', teams ? 'min-w-[20rem]' : 'min-w-[12rem]')} align="end" forceMount>
//               {teams ? (
//                 <>
...
//                       <Link href="/settings/teams?action=add-team" className="flex items-center justify-between">
//                         Create team
...
//                 </DropdownMenuItem>
//                 {selectedTeam && canExecuteTeamAction('MANAGE_TEAM', selectedTeam.currentTeamMember.role) && (
//                   <DropdownMenuItem className="text-muted-foreground px-4 py-2" asChild>
